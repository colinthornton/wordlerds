...
export class Wordle {
  ...
  private validateHardMode(word: string, lastAttempt: Attempt) {
    ...
    for (let i = 0; i < word.length; i++) {
      ...
      if (!presentCounts[letter]) continue;
      presentCounts[letter]--;
    }
    // word must contain all letters marked present
    if (Object.values(presentCounts).some((count) => count > 0)) {
      throw new HardModeError();
    }
  }
...
/** Words able to become solutions */
export const solutions = new Set([
  "aback",
  "abase",
  "abate",
  "abbey",
